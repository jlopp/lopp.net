  ...
  <div class="container">
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1 col-md-10 col-lg-10 col-xs-offset-0 col-xs-12">
          <p class="text-right">
            <a href="pgpkey.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('PGP','','images/pgp-roll.gif',1)" target="_blank"><img src="images/pgp.gif" alt="PGP" width="20" height="20" id="PGP">
            </a>
            ...
            <a href="https://earn.com/lopp/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('earn','','images/earn-roll.gif',1)" target="_blank"><img src="images/earn.gif" alt="earn" width="20" height="20" id="earn">
            </a>
