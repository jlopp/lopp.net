...
/**************
 * Management for LiveSearch V4.2
 *  December 20th 2020
 *  http://codecanyon.net/item/live-search-searchengine-for-your-website/86875?ref=themac
 **************/
"use strict";$(document).ready(function(){$(".toolboxes").masonry({itemSelector:".toolbox"}),$(".tttop").tooltip({placement:"top"}),$("#loginF").length&&($("#loginF input[name='user']").val()?$("#loginF input[name='pass']").focus():$("#loginF input[name='user']").focus()),$(".js-bn-clearSrchStr").on("click",function(){var e=$(this);$.ajax({type:"POST",url:"lsMngr.ajax.php",dataType:"json",async:!1,data:{action:"clearSrchStr"},success:function(s){s.error?new PNotify({title:"Errors occured",text:s.error,type:"error"}):($(e).prop("disabled",!0).addClass("btn-success").removeClass("btn-primary").prepend('<i class="fa fa-check"></i> '),new PNotify({title:"Operations succeeded",text:s.success,type:"success"}))}})}),$(".js-bn-clearSrch").on("click",function(){var e=$(this);$.ajax({type:"POST",url:"lsMngr.ajax.php",dataType:"json",async:!1,data:{action:"clearSrch"},success:function(s){s.error?new PNotify({title:"Errors occured",text:s.error,type:"error"}):($(e).prop("disabled",!0).addClass("btn-success").removeClass("btn-primary").prepend('<i class="fa fa-check"></i> '),new PNotify({title:"Operations succeeded",text:s.success,type:"success"}))}})}),$(".js-bn-clearCache").on("click",function(){var e=$(this);$.ajax({type:"POST",url:"lsMngr.ajax.php",dataType:"json",async:!1,data:{action:"clearCache"},success:function(s){s.error?new PNotify({title:"Errors occured",text:s.error,type:"error"}):($(e).prop("disabled",!0).addClass("btn-success").removeClass("btn-primary").prepend('<i class="fa fa-check"></i> '),$(".badge",e).text(0),new PNotify({title:"Operations succeeded",text:s.success,type:"success"}))}})}),$(".js-btn-cacheFiles").on("click",function(){var e,a=$(this);$.ajax({type:"POST",url:"lsMngr.ajax.php",dataType:"json",async:!1,data:{action:"cacheFiles"},success:function(s){s.error&&(e=s.error)}}),$(a).prop("disabled",!0).prepend('<i class="fa fa-spinner fa-pulse"></i> ');var s='<table class="table table-striped table-hover table-bordered table-condensed status-table"><tbody><tr><td><strong>Temporary Files/Links</strong></td><td class="cfTemp text-right"><span>0</span> <i class="fa fa-spinner fa-pulse fa-fw"></i></td></tr><tr><td><strong>Indexed Files/Urls</strong></td><td class="cfIndexed text-right"><span>0</span> <i class="fa fa-spinner fa-pulse fa-fw"></i></td></tr><tr><td><strong>Indexed Files/Images</strong></td><td class="cfImg text-right"><span>0</span> <i class="fa fa-spinner fa-pulse fa-fw"></i></td></tr><tr><td><strong>Indexed Files/PDFs</strong></td><td class="cfPdf text-right"><span>0</span> <i class="fa fa-spinner fa-pulse fa-fw"></i></td></tr></tbody></table>';e&&(s='<div class="alert alert-info">'+e+"</div>"+s);var t=bootbox.dialog({closeButton:!1,message:'<div class="alert alert-warning status-alert"><div class="row"><div class="col-xs-4 text-right"><i class="fa fa-circle-o-notch fa-spin fa-4x status-icon"></i></div><div class="col-xs-8"><h3 class="status-info">Indexing Site...</h3></div></div></div>'+s+"</div>",className:"bb-CacheFiles",buttons:{cancel:{className:"btn-default disabled bbOK",label:"Processing ...",callback:function(){bootbox.hideAll()}}},onShown:function(){var e=setInterval(function(){$.ajax({type:"POST",url:"lsMngr.ajax.php",dataType:"json",async:!1,data:{action:"getCacheFilesStatus"},success:function(s){$(".status-info",t).text(s.statusMessage),$(".status-table .cfTemp span",t).text(s.tempFiles),$(".status-table .cfIndexed span",t).text(s.dataFiles),$(".status-table .cfImg span",t).text(s.dataImages),$(".status-table .cfPdf span",t).text(s.dataPdfs),s.tempFilesFinished&&$(".status-table .cfTemp i",t).removeClass("fa-spinner fa-pulse").addClass("fa-check text-success"),s.dataFilesFinished&&($(".status-table .cfIndexed i",t).removeClass("fa-spinner fa-pulse").addClass("fa-check text-success"),$(".btn-default.bbOK",t).removeClass("btn-default disabled").addClass("btn-primary").text("Close")),s.finished&&($(".status-alert",t).removeClass("alert-warning").addClass("alert-success"),$(".status-icon",t).removeClass("fa-circle-o-notch fa-spin").addClass("fa-check text-success"),$(".status-table .cfImg i,.status-table .cfPdf i",t).removeClass("fa-spinner fa-pulse").addClass("fa-check text-success"),new PNotify({title:"Operations succeeded",text:s.success,type:"success"}),$(a).prop("disabled",!0).addClass("btn-success").removeClass("btn-primary"),$(a).parent().attr("title","just indexed, to cache files again, please reload page").tooltip(),$("i",a).removeClass("fa-spinner fa-pulse").addClass("fa-check"),clearInterval(e))}})},2500)}})})});