...
class LiveSearch {
  ...
  var $basepath = "/homepages/18/d206208053/htdocs/";
  ...
  //absolute URL to your ls folder with trailing slash
  var $lsurl = "http://www.lopp.net/ls/";
  ...
  var $cachetime = 240;    //-1 for cache every time when searching, 0 when caching should not happen
  ...
  var $collect_images = false;   //true if you like to search for images too, false if not
  ...
  var $mngrUser = "admin";
  var $mngrPass = "admin";   //please choose your password
